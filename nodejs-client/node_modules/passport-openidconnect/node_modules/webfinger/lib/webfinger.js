...
var JSONTYPE = "application/jrd+json",
...
var httpHostMeta = function(address, callback) {
    ...
    var options = {
        ...
        method: "GET",
        headers: {
            accept: "application/jrd+json, application/xrd+xml; q=0.5"
        }
    };

    request(http, options, {"application/jrd+json": jrd, "application/xrd+xml": xrd2jrd}, callback);
};
...
var httpHostMetaJSON = function(address, callback) {
    ...
    request(http, options, {"application/jrd+json": jrd}, callback);
};
...
var httpsHostMeta = function(address, httpsOnly, callback) {
    ...
    request(https, options, {"application/jrd+json": jrd, "application/xrd+xml": xrd2jrd}, callback);
};
    ...
    Step(
        ...
        function(err, hm) {
            ...
            if (json && json.length > 0) {
                template(json[0].template, address, {"application/jrd+json": jrd}, options.httpsOnly, this);
                return;
            }
